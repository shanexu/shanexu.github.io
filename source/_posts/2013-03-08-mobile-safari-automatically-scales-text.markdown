...
{% img http://106.187.36.166/shanexu.org/images/mobile_safari-1.png '#1' 'Mobile Safari automatically scales text' %}
...
{% img http://106.187.36.166/shanexu.org/images/mobile_safari-2.png '#2' 'set -webkit-text-size-adjus to 100%' %}
